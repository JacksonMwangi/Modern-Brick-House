...
void Initialize() {
	...
	Image* image = loadBMP("C:\\Users\\Hp\\Desktop\\tplaza\\tplaza\\bricks.bmp");
	_textureBrick = loadTexture(image);
	image = loadBMP("C:\\Users\\Hp\\Desktop\\tplaza\\tplaza\\door.bmp");
	_textureDoor = loadTexture(image);
	image = loadBMP("C:\\Users\\Hp\\Desktop\\tplaza\\tplaza\\grass.bmp");
	_textureGrass = loadTexture(image);
	image = loadBMP("C:\\Users\\Hp\\Desktop\\tplaza\\tplaza\\door.bmp");
	_textureRoof = loadTexture(image);
	image = loadBMP("C:\\Users\\Hp\\Desktop\\tplaza\\tplaza\\window.bmp");
	_textureWindow = loadTexture(image);
	image = loadBMP("C:\\Users\\Hp\\Desktop\\tplaza\\tplaza\\sky.bmp");
...
int main(int argc, char **argv) {
	...
	glutCreateWindow("bbit may 2018");
